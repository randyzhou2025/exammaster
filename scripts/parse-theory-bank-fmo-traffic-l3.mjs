/**
 * 从「全媒体运营师_流量运营三级_理论知识复习题.pdf」+ 答案速查 md 导入理论题库
 * 用法：npm run import-theory-bank-fmo-traffic-l3
 */
...
const PDF_PATH = path.join(root, "题库", "全媒体运营师_流量运营三级_理论知识复习题.pdf");
const ANSWERS_PATH = path.join(
  root,
  "题库",
  "全媒体运营师_流量运营三级_理论知识复习题_答案速查.md"
);

const ID_PREFIX = { judgment: "fmt-j", single: "fmt-s", multiple: "fmt-m" };
...
async function main() {
  ...
  const outPath = path.join(root, "src", "data", "theoryBankFmoTrafficL3.json");
